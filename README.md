...
# Содержание
  ...
  0. [Работа с анонимными функциями](#Работа-с-анонимными-функциями)
...
### 📖 Файлы классов должны быть расположены в директориях в соответствии со стандартом PSR-4
Кроме случаев, когда это невозможно из-за ограничений накладываемых фреймворком
...
### 📖 При объявлении анонимных функций использовать static везде где явно не требуется обратное
...
class LargeObject {
    public function getClosure(): Closure {
        return static function () { // Внутри функции любые вычисления
            // ...
        };
    }
}
...
[зачем это?](https://habr.com/ru/post/561550/)
